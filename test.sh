...
echo "=========================================="
echo "Run vegeta to Normal(1req/sec, 30sec)"
docker run --name normal-vegeta --rm --network normal_py310_default -i peterevans/vegeta sh -c "echo 'GET http://fastapi-py310-normal:5000/' | vegeta attack -rate=1 -duration=30s | tee results.bin | vegeta report"
echo "=========================================="
echo "Run fastapi-py3112-normal"
echo "=========================================="
echo "Run vegeta to Normal(1req/sec, 30sec)"
docker run --name normal-vegeta --rm --network normal_py3112_default -i peterevans/vegeta sh -c "echo 'GET http://fastapi-py3112-normal:5000/' | vegeta attack -rate=1 -duration=30s | tee results.bin | vegeta report"
echo "=========================================="
